...
On utilise le coefficient de variation (CV) de la moyenne mobile 3 ans du pourcentage des naissances
annuelles dans le temps où $$CV = \frac{\sigma}{\mu}$$
...
- On élimine les prénoms avec des accents<sup>6</sup>.
...
- On élimine les prénoms qui ont un CV > 1.
